...
import { Search, Star, Clock, Video, CheckCircle2, ChevronRight, CalendarDays, Coins, Filter, X } from "lucide-react";
...
const getDoctorImage = (name: string) => {
  ...
  if (lowercaseName.includes("rivera") || lowercaseName.includes("chen") || lowercaseName.includes("marcus")) return "/dr_marco_rivera.png";
...
export default function BrowseDoctorsPage() {
  ...
  const handleBookAppointment = async () => {
    ...
    // Hardcode mock patient id for demo since session is running client side
    // In production we pull this from auth session
    const mockPatientId = "1a8f9b2c-3d4e-5f6g-7h8i-9j0k1l2m3n4o"; 
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 max-w-7xl mx-auto">
      ...
      {/* Booking Dialog Modal (Consolidates confirm specialist styles from image 2) */}
        ...
        {selectedDoctor && (
          <DialogContent className="max-w-md rounded-3xl p-6 bg-white border border-slate-100">
            ...
            <div className="space-y-5 pt-3">
              ...
              {/* Doctor Details card representation (Image 2) */}
